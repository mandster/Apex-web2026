    ...
    <section className="hero-premium hero-atmosphere">
      ...
      <div className="hero-shell editorial-hero">
        <div className="hero-copy-block reveal reveal-delay-1">
          <h1>Apex Electricals – Industrial Electrical Control and Safety Systems &amp; Switchgear Solutions</h1>
        </div>

        <div className="hero-side-block reveal reveal-delay-2">
          <p className="hero-subtitle">
            Since 1975, Apex has engineered switchgear and Motor Control Systems for consistent, Real-World performance across Industry, Agriculture, and Domestic applications.
          </p>
